...
public class Everest2 : MonoBehaviour
{
    [Header("Inscribed")]
    ...
    void OxygenDeath(){
        SceneManager.LoadScene("OxygenDeprivationAlpha");
    }
    void Hypothermia(){
        SceneManager.LoadScene("HypothermiaAlpha");
    }
    ...
    void Update()
    {
        ...
        if (pos.y>146){
            SceneManager.LoadScene("BaseCampBeta");
        }
    }
}